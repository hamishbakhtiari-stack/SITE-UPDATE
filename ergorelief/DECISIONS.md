...
| 10 | Mobile sticky bar "Add to Cart" (snippets/sticky-atc + assets/sticky-atc.js, sitewide) | clicks first .product-form__submit = hero ATC | OK (added to audit 2026-09-23 after owner re-sent the request) |
