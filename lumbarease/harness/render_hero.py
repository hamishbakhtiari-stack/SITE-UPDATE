...
def block_html(bid, b):
    ...
    if ty == 'title':
        return ('<div class="product__title"><h1>LumbarEase™ Lumbar Support</h1>'
                '<a href="#" class="product__title"><h2 class="h1">LumbarEase™ Lumbar Support</h2></a></div>')
    ...
    if ty == 'price':
        return (f'<div id="price-{SID}" role="status"><div class="price price--large price--on-sale price--show-badge">'
                '<div class="price__container"><div class="price__regular"><span class="price-item price-item--regular">$62.00</span></div>'
                '<div class="price__sale"><span><s class="price-item price-item--regular">$79</s></span>'
                '<span class="price-item price-item--sale price-item--last">$62</span></div></div>'
                '<span class="badge price__badge-sale color-scheme-4">Save $17</span></div></div>'
    ...
    if ty == 'buy_buttons':
        return ('<div><product-form class="product-form"><form><div class="product-form__buttons">'
                ...
                '<span>Add LumbarEase to cart</span></button>'
